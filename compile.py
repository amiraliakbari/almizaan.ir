...
def write_data(surah, ayah, data):
    os.makedirs(os.path.join('dist', 'data', str(surah)), exist_ok=True)
    with open(os.path.join('dist', 'data', str(surah), '{}.html'.format(ayah)), 'w') as output_file:
        output_file.write(data)
    with open(os.path.join('dist', 'quran', 'index.html')) as template_file:
        template = template_file.read()
    os.makedirs(os.path.join('dist', 'quran', str(surah), str(ayah)), exist_ok=True)
    with open(os.path.join('dist', 'quran', str(surah), str(ayah), 'index.html'), 'w') as output_file:
